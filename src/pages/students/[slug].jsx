              ...
              <div className="box">
                ...
                <div className="box-body no-padding">
                  <ul className="nav nav-pills flex-column">
                    <li className="nav-item"><a href="#" className="nav-link">Location <span className="badge badge-pill badge-primary float-end">{studentData.location}</span></a></li>
                    <li className="nav-item"><a href="#" className="nav-link">Interest <span className="badge badge-pill badge-info float-end">{studentData.interest}</span></a></li>
                    <li className="nav-item"><a href="#" className="nav-link">Language <span className="badge badge-pill badge-danger float-end">{studentData.language}</span></a></li>
                  </ul>
                </div>
              </div>
            </div>
